...
const Navbar = () => {
  ...
  return (
    ...
    <div
      ...
      <div className="flex h-full items-center justify-center gap-5 max-md:hidden [&>a]:select-none [&>a]:rounded [&>a]:px-3 [&>a]:py-1 [&>a]:text-black [&>a]:outline [&>a]:outline-1 [&>a]:outline-[#25292e] [&>a]:transition-colors [&>a]:duration-100 [&>a]:dark:bg-black [&>a]:dark:text-white">
        <Link
          to="/products/"
      ...
      {!dropdownIsToggled && (
        <div className="fixed top-16 flex w-56 flex-col gap-2 rounded-md border bg-black bg-opacity-50 p-5 py-7 text-lg max-md:right-12 max-sm:left-0 max-sm:right-0 max-sm:mx-auto max-sm:w-[80%] md:hidden dark:text-black [&>a]:truncate [&>a]:rounded-sm [&>a]:border [&>a]:border-black [&>a]:bg-white [&>a]:py-2 [&>a]:text-center">
